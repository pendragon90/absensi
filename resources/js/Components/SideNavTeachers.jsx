...
export default function SideNavTeachers() {
        ...
        <nav>
            ...
            >
                ...
                <div className="h-full px-3 py-4 overflow-y-auto flex flex-col gap-5">
                    ...
                    <Link href="/dashboard/students/absence/" className="flex gap-4 items-center">
                        <MdOutlineDashboard />
                            Daftar Absensi Murid
                        </Link>
                    </div>
                    <div className="space-y-2 font-medium">
                        <Link href="/dashboard/teachers" className="flex gap-4 items-center">
                            <FaUsers />
                            Daftar Guru
                        </Link>
                    </div>
                    <div className="space-y-2 font-medium">
                        <Link href="/dashboard/students" className="flex gap-4 items-center">
                            <FaUsers />
                            Daftar Murid
                        </Link>
                    </div>
                    <div className="space-y-2 font-medium">
                        <Link href="/dashboard/classrooms" className="flex gap-4 items-center">
                        <SiGoogleclassroom />
                            Kelas
                        </Link>
                    </div>
