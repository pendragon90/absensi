        ...
        <>
            ...
            >
                ...
                <h1 className="text-lg text-center">
                        {dayjs(data.deleteByMonth[0]).format('D MMMM YYYY')} - {dayjs(data.deleteByMonth[1]).format('D MMMM YYYY')}
                    </h1>
                <MonthPicker
...
<div className="mt-5">
                ...
                <Button fullWidth leftSection={<MdDelete className="h-5" />}
                color="red" onClick={handleDelete}>Hapus</Button>
</div>
            </Modal>
            <Button
